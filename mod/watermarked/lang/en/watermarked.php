...
/**
 * Strings for component 'watermarked', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['configparametersettings'] = 'This sets the default value for the Parameter settings pane in the form when adding some new watermarkeds. After the first time, this becomes an individual user preference.';
$string['configpopup'] = 'When adding a new watermarked which is able to be shown in a popup window, should this option be enabled by default?';
...
$string['dnduploadwatermarked'] = 'Create file watermarked';
...
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a File watermarked.';
$string['indicator:cognitivedepthdef'] = 'File cognitive';
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the File watermarkeds during this analysis interval (Levels = No view, View)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'File social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a File watermarked.';
$string['indicator:socialbreadthdef'] = 'File social';
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the File watermarkeds during this analysis interval (Levels = No participation, Participant alone)';
$string['indicator:socialbreadthdef_link'] = 'Learning_analytics_indicators#Social_breadth';
$string['legacyfiles'] = 'Migration of old course file';
$string['legacyfilesactive'] = 'Active';
$string['legacyfilesdone'] = 'Finished';
$string['modifieddate'] = 'Modified {$a}';
$string['modulename'] = 'Watermarked File';
$string['modulename_help'] = 'The watermarked file module enables a teacher to provide a file as a course watermarked. Where possible, the file will be displayed within the course interface; otherwise students will be prompted to download it. The file may include supporting files, for example an HTML page may have embedded images.
...
* To include a mini website as a course watermarked
* To provide draft files of software programs so students can edit and submit them for assessment';
$string['modulename_link'] = 'mod/watermarked/view';
$string['modulenameplural'] = 'Files';
$string['notmigrated'] = 'This legacy watermarked type ({$a}) was not yet migrated, sorry.';
$string['optionsheader'] = 'Display options';
$string['page-mod-watermarked-x'] = 'Any file module page';
$string['pluginadministration'] = 'File module administration';
$string['pluginname'] = 'Watermarked File';
$string['popupheight'] = 'Pop-up height (in pixels)';
$string['popupheightexplain'] = 'Specifies default height of popup windows.';
$string['popupwatermarked'] = 'This watermarked should appear in a popup window.';
$string['popupwatermarkedlink'] = 'If it didn\'t, click here: {$a}';
$string['popupwidth'] = 'Pop-up width (in pixels)';
$string['popupwidthexplain'] = 'Specifies default width of popup windows.';
$string['printintro'] = 'Display watermarked description';
$string['printintroexplain'] = 'Display watermarked description below content? Some display types may not display description even if enabled.';
$string['privacy:metadata'] = 'The File watermarked plugin does not store any personal data.';
$string['watermarked:addinstance'] = 'Add a new watermarked';
$string['watermarkedcontent'] = 'Files and subfolders';
$string['watermarkeddetails_sizetype'] = '{$a->size} {$a->type}';
$string['watermarkeddetails_sizedate'] = '{$a->size} {$a->date}';
$string['watermarkeddetails_typedate'] = '{$a->type} {$a->date}';
$string['watermarkeddetails_sizetypedate'] = '{$a->size} {$a->type} {$a->date}';
$string['watermarked:exportwatermarked'] = 'Export watermarked';
$string['watermarked:view'] = 'View watermarked';
$string['search:activity'] = 'Watermarked File';
...
If there are multiple files in this watermarked, the start file upload/modified date is displayed.';
$string['showsize'] = 'Show size';
$string['showsize_help'] = 'Displays the file size, such as \'3.1 MB\', beside links to the file.

If there are multiple files in this watermarked, the total size of all files is displayed.';
...
If there are multiple files in this watermarked, the start file type is displayed.
