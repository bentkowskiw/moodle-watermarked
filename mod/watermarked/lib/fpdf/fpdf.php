...
class FPDF {
	...
	// Needed for opacity/transparancy
	...
	protected function _loadfont( $font ) {
		...
		include $this->fontpath . $font; // nosemgrep: audit.php.lang.security.file.inclusion-arg
		...
		return get_defined_vars(); // phpcs:ignore QITStandard.PHP.DebugCode.DebugFunctionFound
	}
	...
	protected function _httpencode( $param, $value, $isUTF8 ) {
		...
		if ( strpos( $_SERVER['HTTP_USER_AGENT'], 'MSIE' ) !== false ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
