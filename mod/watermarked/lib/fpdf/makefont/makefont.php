...
function Message( $txt, $severity = '' ) {
	if ( PHP_SAPI == 'cli' ) {
		if ( $severity ) {
			echo "$severity: "; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		}
		echo "$txt\n"; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	} else {
		if ( $severity ) {
			echo "<b>$severity</b>: "; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		}
		echo "$txt<br>"; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
}
