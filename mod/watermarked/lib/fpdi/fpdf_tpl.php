...
class FPDF_TPL extends fpdi_bridge
{
    ...
    {
        if (is_subclass_of($this, 'TCPDF')) {
            return call_user_func_array(array($this, 'TCPDF::endTemplate'));
        }
    ...
    {
        if (is_subclass_of($this, 'TCPDF')) {
            return call_user_func_array(array($this, 'TCPDF::SetFont'), [$family, $style, $size, $fontfile, $subset, $out]);
        }
    ...
    {
        if (is_subclass_of($this, 'TCPDF')) {
            return call_user_func_array(array($this, 'TCPDF::Image'), [$file, $x, $y, $w, $h, $type, $link, $align, $resize, $dpi, $palign, $ismask, $imgmask, $border, $fitbox, $hidden, $fitonpage, $alt, $altimgs]);
        }
    ...
    {
        if (is_subclass_of($this, 'TCPDF')) {
            return call_user_func_array(array($this, 'TCPDF::AddPage'), [$orientation, $format, $keepmargins, $tocpage]);
        }
    ...
    {
        if (is_subclass_of($this, 'TCPDF')) {
            return call_user_func_array(array($this, 'TCPDF::Link'), [$x, $y, $w, $h, $link, $spaces]);
        }
    ...
    {
        if (is_subclass_of($this, 'TCPDF')) {
            return call_user_func_array(array($this, 'TCPDF::AddLink'));
        }
    ...
    {
        if (is_subclass_of($this, 'TCPDF')) {
            return call_user_func_array(array($this, 'TCPDF::SetLink'), [$link, $y, $page]);
        }
