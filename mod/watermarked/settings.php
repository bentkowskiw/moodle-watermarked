...
if ($ADMIN->fulltree) {
    require_once("$CFG->libdir/watermarkedlib.php");
	

	

    $displayoptions = resourcelib_get_displayoptions(array(WATERMARKEDLIB_DISPLAY_AUTO,
                                                           WATERMARKEDLIB_DISPLAY_EMBED,
                                                           WATERMARKEDLIB_DISPLAY_FRAME,
                                                           WATERMARKEDLIB_DISPLAY_DOWNLOAD,
                                                           WATERMARKEDLIB_DISPLAY_OPEN,
                                                           WATERMARKEDLIB_DISPLAY_NEW,
                                                           WATERMARKEDLIB_DISPLAY_POPUP,
                                                          ));
    $defaultdisplayoptions = array(WATERMARKEDLIB_DISPLAY_AUTO,
                                   WATERMARKEDLIB_DISPLAY_EMBED,
                                   WATERMARKEDLIB_DISPLAY_DOWNLOAD,
                                   WATERMARKEDLIB_DISPLAY_OPEN,
                                   WATERMARKEDLIB_DISPLAY_POPUP,
    ...
    $settings->add(new admin_setting_configselect('resource/display',
        get_string('displayselect', 'resource'), get_string('displayselectexplain', 'resource'), WATERMARKEDLIB_DISPLAY_AUTO,
        $displayoptions));
